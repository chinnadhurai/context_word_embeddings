...
class MODEL:
    ...
    def context_boW(self, input_var, param_type=None):
        ...
        print "Done building context_boW ..."
        return net
    ...
    # build wc model
    def wc_model_vanilla(self):
        
        l_param_type = [ 'cbow_context', 'qlstm', 'final_mlp' ]
        #skip gram
        cbow_context_net = self.context_boW(context,param_type=l_param_type[0])['l_out']
